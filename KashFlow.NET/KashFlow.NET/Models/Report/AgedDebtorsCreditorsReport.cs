...
namespace KashFlow.NET.Models.Report
{
	...
	public class AgedDebtorsCreditorsReport : KashFlowBase<KashFlow.AgedDebtorsCreditors>
	{
		...
		/// </summary>
		public decimal Older { get; set; }

		/// <summary>
		/// The month before that of the specified End Date (‘Current’ month)
		/// </summary>
		public AgedDebtorsCreditorsPeriod Period1 { get; set; }

		/// <summary>
		/// The month previous to ‘Period1’
		/// </summary>
		public AgedDebtorsCreditorsPeriod Period2 { get; set; }

		/// <summary>
		/// The month previous to ‘Period2’
		/// </summary>
		public AgedDebtorsCreditorsPeriod Period3 { get; set; }
